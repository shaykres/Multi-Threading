...
public abstract class MicroService implements Runnable {
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
       ...
       // System.out.println(this.getName()+" subscribed event to "+type.getName());
    }
    ...
    public final void run() {
        ...
        while (!terminated) {
            ...
            if((message instanceof TickFinishBroadCast)) {
               System.out.println(this.getName() + " got message " + message.getClass());
           }
	    if(message!=null&&CallbackMap.get(message.getClass())!=null)
